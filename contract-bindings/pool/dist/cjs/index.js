    ...
    parsers = {
        initialize: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("initialize", result));
        },
        upgrade: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("upgrade", result));
        },
        upgradeSToken: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("upgrade_s_token", result));
        },
        upgradeDebtToken: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("upgrade_debt_token", result));
        },
        version: (result) => this.spec.funcResToNative("version", result),
        initReserve: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("init_reserve", result));
        },
        setReserveStatus: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("set_reserve_status", result));
        },
        setIrParams: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("set_ir_params", result));
        },
        reserveTimestampWindow: (result) => this.spec.funcResToNative("reserve_timestamp_window", result),
        setReserveTimestampWindow: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("set_reserve_timestamp_window", result));
        },
        irParams: (result) => this.spec.funcResToNative("ir_params", result),
        enableBorrowingOnReserve: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("enable_borrowing_on_reserve", result));
        },
        configureAsCollateral: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("configure_as_collateral", result));
        },
        getReserve: (result) => this.spec.funcResToNative("get_reserve", result),
        collatCoeff: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("collat_coeff", result));
        },
        debtCoeff: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("debt_coeff", result));
        },
        baseAsset: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("base_asset", result));
        },
        setBaseAsset: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("set_base_asset", result));
        },
        initialHealth: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("initial_health", result));
        },
        setInitialHealth: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("set_initial_health", result));
        },
        setPriceFeeds: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("set_price_feeds", result));
        },
        priceFeeds: (result) => this.spec.funcResToNative("price_feeds", result),
        deposit: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("deposit", result));
        },
        repay: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("repay", result));
        },
        finalizeTransfer: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("finalize_transfer", result));
        },
        withdraw: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("withdraw", result));
        },
        borrow: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("borrow", result));
        },
        setPause: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("set_pause", result));
        },
        ...
        accountPosition: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("account_position", result));
        },
        liquidate: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("liquidate", result));
        },
        setAsCollateral: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("set_as_collateral", result));
        },
        userConfiguration: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("user_configuration", result));
        },
        ...
        setFlashLoanFee: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("set_flash_loan_fee", result));
        },
        flashLoanFee: (result) => this.spec.funcResToNative("flash_loan_fee", result),
        flashLoan: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("flash_loan", result));
        },
        twapMedianPrice: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("twap_median_price", result));
        },
...
*/
    initialize = async ({ admin, treasury, flash_loan_fee, initial_health, ir_params }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            method: 'initialize',
            args: this.spec.funcArgsToScVals("initialize", { admin: new stellar_sdk_1.Address(admin), treasury: new stellar_sdk_1.Address(treasury), flash_loan_fee, initial_health, ir_params }),
            ...options,
            ...this.options,
...
*/
    upgradeSToken = async ({ asset, new_wasm_hash }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            ...
            args: this.spec.funcArgsToScVals("upgrade_s_token", { asset: new stellar_sdk_1.Address(asset), new_wasm_hash }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    upgradeDebtToken = async ({ asset, new_wasm_hash }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            ...
            args: this.spec.funcArgsToScVals("upgrade_debt_token", { asset: new stellar_sdk_1.Address(asset), new_wasm_hash }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    initReserve = async ({ asset, reserve_type }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            method: 'init_reserve',
            args: this.spec.funcArgsToScVals("init_reserve", { asset: new stellar_sdk_1.Address(asset), reserve_type }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    setReserveStatus = async ({ asset, is_active }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            ...
            args: this.spec.funcArgsToScVals("set_reserve_status", { asset: new stellar_sdk_1.Address(asset), is_active }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    enableBorrowingOnReserve = async ({ asset, enabled }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            ...
            args: this.spec.funcArgsToScVals("enable_borrowing_on_reserve", { asset: new stellar_sdk_1.Address(asset), enabled }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    configureAsCollateral = async ({ asset, params }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            ...
            args: this.spec.funcArgsToScVals("configure_as_collateral", { asset: new stellar_sdk_1.Address(asset), params }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    getReserve = async ({ asset }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            method: 'get_reserve',
            args: this.spec.funcArgsToScVals("get_reserve", { asset: new stellar_sdk_1.Address(asset) }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    collatCoeff = async ({ asset }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            method: 'collat_coeff',
            args: this.spec.funcArgsToScVals("collat_coeff", { asset: new stellar_sdk_1.Address(asset) }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    debtCoeff = async ({ asset }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            method: 'debt_coeff',
            args: this.spec.funcArgsToScVals("debt_coeff", { asset: new stellar_sdk_1.Address(asset) }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    setBaseAsset = async ({ asset, decimals }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            ...
            args: this.spec.funcArgsToScVals("set_base_asset", { asset: new stellar_sdk_1.Address(asset), decimals }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    priceFeeds = async ({ asset }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            method: 'price_feeds',
            args: this.spec.funcArgsToScVals("price_feeds", { asset: new stellar_sdk_1.Address(asset) }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    deposit = async ({ who, asset, amount }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            method: 'deposit',
            args: this.spec.funcArgsToScVals("deposit", { who: new stellar_sdk_1.Address(who), asset: new stellar_sdk_1.Address(asset), amount }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    repay = async ({ who, asset, amount }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            method: 'repay',
            args: this.spec.funcArgsToScVals("repay", { who: new stellar_sdk_1.Address(who), asset: new stellar_sdk_1.Address(asset), amount }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    finalizeTransfer = async ({ asset, from, to, amount, balance_from_before, balance_to_before, s_token_supply }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            ...
            args: this.spec.funcArgsToScVals("finalize_transfer", { asset: new stellar_sdk_1.Address(asset), from: new stellar_sdk_1.Address(from), to: new stellar_sdk_1.Address(to), amount, balance_from_before, balance_to_before, s_token_supply }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    withdraw = async ({ who, asset, amount, to }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            method: 'withdraw',
            args: this.spec.funcArgsToScVals("withdraw", { who: new stellar_sdk_1.Address(who), asset: new stellar_sdk_1.Address(asset), amount, to: new stellar_sdk_1.Address(to) }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    borrow = async ({ who, asset, amount }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            method: 'borrow',
            args: this.spec.funcArgsToScVals("borrow", { who: new stellar_sdk_1.Address(who), asset: new stellar_sdk_1.Address(asset), amount }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    accountPosition = async ({ who }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            ...
            args: this.spec.funcArgsToScVals("account_position", { who: new stellar_sdk_1.Address(who) }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    liquidate = async ({ liquidator, who, receive_stoken }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            method: 'liquidate',
            args: this.spec.funcArgsToScVals("liquidate", { liquidator: new stellar_sdk_1.Address(liquidator), who: new stellar_sdk_1.Address(who), receive_stoken }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    setAsCollateral = async ({ who, asset, use_as_collateral }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            ...
            args: this.spec.funcArgsToScVals("set_as_collateral", { who: new stellar_sdk_1.Address(who), asset: new stellar_sdk_1.Address(asset), use_as_collateral }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    userConfiguration = async ({ who }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            ...
            args: this.spec.funcArgsToScVals("user_configuration", { who: new stellar_sdk_1.Address(who) }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    stokenUnderlyingBalance = async ({ stoken_address }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            ...
            args: this.spec.funcArgsToScVals("stoken_underlying_balance", { stoken_address: new stellar_sdk_1.Address(stoken_address) }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    tokenBalance = async ({ token, account }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            ...
            args: this.spec.funcArgsToScVals("token_balance", { token: new stellar_sdk_1.Address(token), account: new stellar_sdk_1.Address(account) }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    tokenTotalSupply = async ({ token }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            ...
            args: this.spec.funcArgsToScVals("token_total_supply", { token: new stellar_sdk_1.Address(token) }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    flashLoan = async ({ who, receiver, loan_assets, params }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            method: 'flash_loan',
            args: this.spec.funcArgsToScVals("flash_loan", { who: new stellar_sdk_1.Address(who), receiver: new stellar_sdk_1.Address(receiver), loan_assets, params }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    twapMedianPrice = async ({ asset, amount }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            ...
            args: this.spec.funcArgsToScVals("twap_median_price", { asset: new stellar_sdk_1.Address(asset), amount }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    balance = async ({ id, asset }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            method: 'balance',
            args: this.spec.funcArgsToScVals("balance", { id: new stellar_sdk_1.Address(id), asset: new stellar_sdk_1.Address(asset) }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
