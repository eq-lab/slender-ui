...
class Contract {
    ...
    parsers = {
        ...
        setPriceFeed: (result) => {
            if (result instanceof assembled_tx_js_1.Err)
                return result;
            return new assembled_tx_js_1.Ok(this.spec.funcResToNative("set_price_feed", result));
        },
...
*/
    initialize = async ({ admin, treasury, flash_loan_fee, ir_params }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            method: 'initialize',
            args: this.spec.funcArgsToScVals("initialize", { admin: new stellar_sdk_1.Address(admin), treasury: new stellar_sdk_1.Address(treasury), flash_loan_fee, ir_params }),
            ...options,
            ...this.options,
...
*/
    initReserve = async ({ asset, input }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            method: 'init_reserve',
            args: this.spec.funcArgsToScVals("init_reserve", { asset: new stellar_sdk_1.Address(asset), input }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    priceFeed = async ({ asset }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            method: 'price_feed',
            args: this.spec.funcArgsToScVals("price_feed", { asset: new stellar_sdk_1.Address(asset) }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
...
*/
    liquidate = async ({ liquidator, who, debt_asset, receive_stoken }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            method: 'liquidate',
            args: this.spec.funcArgsToScVals("liquidate", { liquidator: new stellar_sdk_1.Address(liquidator), who: new stellar_sdk_1.Address(who), debt_asset: new stellar_sdk_1.Address(debt_asset), receive_stoken }),
            ...options,
            ...this.options,
            errorTypes: exports.Errors,
