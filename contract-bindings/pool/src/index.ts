...
function LiquidationCollateralToXdr(liquidationCollateral?: LiquidationCollateral): xdr.ScVal {
...
function LiquidationCollateralFromXdr(base64Xdr: string): LiquidationCollateral {
    ...
    return {
        ...
        asset_price: scValToJs(map.get("asset_price")) as unknown as i128,
        collat_coeff: scValToJs(map.get("collat_coeff")) as unknown as i128,
        reserve_data: scValToJs(map.get("reserve_data")) as unknown as ReserveData,
        s_token_balance: scValToJs(map.get("s_token_balance")) as unknown as i128
    };
}
