 ...
 *
 */
    initialize<R extends ResponseTypes = undefined>({ name, symbol, pool, underlying_asset }: {
        name: string;
        symbol: string;
        pool: Address;
 ...
 */
    authorized<R extends ResponseTypes = undefined>({ id }: {
        id: Address;
    }, options?: {
        /**
         * The fee to pay for the transaction. Default: 100.
 ...
 */
    ...
    burnFrom<R extends ResponseTypes = undefined>({ _spender, _from, _amount }: {
        _spender: Address;
        _from: Address;
        _amount: i128;
    }, options?: {
 ...
 *
 */
    clawback<R extends ResponseTypes = undefined>({ from, amount }: {
        from: Address;
        amount: i128;
    }, options?: {
        /**
 ...
 *
 */
    setAuthorized<R extends ResponseTypes = undefined>({ id, authorize }: {
        id: Address;
        authorize: boolean;
    }, options?: {
        /**
 ...
 *
 */
    burn<R extends ResponseTypes = undefined>({ from, amount_to_burn, amount_to_withdraw, to }: {
        from: Address;
        amount_to_burn: i128;
 ...
 *
 */
    totalSupply<R extends ResponseTypes = undefined>(options?: {
        /**
         * The fee to pay for the transaction. Default: 100.
         */
        fee?: number;
 ...
 *
 */
    transferOnLiquidation<R extends ResponseTypes = undefined>({ from, to, amount }: {
        from: Address;
        to: Address;
        amount: i128;
    }, options?: {
 ...
 *
 */
    transferUnderlyingTo<R extends ResponseTypes = undefined>({ to, amount }: {
        to: Address;
        amount: i128;
    }, options?: {
        /**
 ...
 *
 */
    underlyingAsset<R extends ResponseTypes = undefined>(options?: {
        /**
         * The fee to pay for the transaction. Default: 100.
         */
        fee?: number;
 ...
 *
 */
    pool<R extends ResponseTypes = undefined>(options?: {
        /**
         * The fee to pay for the transaction. Default: 100.
         */
        fee?: number;
